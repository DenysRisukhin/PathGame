...
struct Button
{
	...
	*/
	Button(Game* game, const MenuInfo& config, s32 index)
	{
...
struct Column
{
	...
	*/
	Column(Game* game, const MenuInfo& config, s32 index)
	{
...
Menu::Menu(Game* game, const StageConfig& stage)
	: Stage(game, stage, "menu")
	, _config(game, stage.ConfigFilename), _node(NULL)
{
	createOrthoCamera();
	createBackground();
