	...
	, _config(game, stage.ConfigFilename)
{
	...
	_node = scene->addMeshSceneNode(geometry->createPlaneMesh(dimension2d<f32>((f32)textureSize.Width,(f32)textureSize.Height),dimension2d<u32>(1, 1), &material, dimension2d<f32>(1, 1)), _rootNode);
